...
ModelTest_Dyn::setFomc(double* f, propertyF_t type) {
  if (type != DIFFERENTIAL_EQ) {
...

    {
      ...
      f[3] = data->localData[0]->realVars[3] /*  z variable  */ -
             ((4.0) * ((data->localData[0]->realVars[1] /* x variable */) * (data->localData[0]->realVars[0] /* u STATE(1) */)));
    }
  }
...
ModelTest_Dyn::setY0omc() {
  ...
  {
    data->localData[0]->realVars[3] /* z variable */ =
        (4.0) * ((data->localData[0]->realVars[1] /* x variable */) * (data->localData[0]->realVars[0] /* u STATE(1) */));
  }
}
