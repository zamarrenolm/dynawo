...
void
ModelTestSilentZ_Dyn::initData(DYNDATA* d) {
  setData(d);
  setupDataStruc();
  initializeDataStruc();
}
...
void
ModelTestSilentZ_Dyn::setupDataStruc() {
...
void
ModelTestSilentZ_Dyn::initializeDataStruc() {
...
void
ModelTestSilentZ_Dyn::deInitializeDataStruc() {
...
void
ModelTestSilentZ_Dyn::setFomc(double* f, propertyF_t type) {
...
modeChangeType_t
ModelTestSilentZ_Dyn::evalMode(const double& t) const {
...
void
ModelTestSilentZ_Dyn::setZomc() {
  data->simulationInfo->discreteCall = 1;

  // -------------------- b ---------------------
  data->localData[0]->discreteVars[0] /* b DISCRETE */ =
      fromNativeBool(((modelica_integer)data->localData[0]->integerDoubleVars[0] /* z2 DISCRETE */ == ((modelica_integer)2)));
...
void
ModelTestSilentZ_Dyn::collectSilentZ(bool* silentZTable) {
  silentZTable[2] /* z3 */ = true;
  silentZTable[0] /* b */ = true;
}

void
ModelTestSilentZ_Dyn::setGomc(state_g* gout) {
  data->simulationInfo->discreteCall = 1;
...
void
ModelTestSilentZ_Dyn::callCustomParametersConstructors() {}

void
ModelTestSilentZ_Dyn::setYType_omc(propertyContinuousVar_t* yType) {
  yType[0] = DIFFERENTIAL; /* u (rSta)  */
}

void
ModelTestSilentZ_Dyn::setFType_omc(propertyF_t* fType) {
  fType[0] = DIFFERENTIAL_EQ;
}

boost::shared_ptr<parameters::ParametersSet>
ModelTestSilentZ_Dyn::setSharedParametersDefaultValues() {
...
void
ModelTestSilentZ_Dyn::setParameters(boost::shared_ptr<parameters::ParametersSet> params) {}

void
ModelTestSilentZ_Dyn::defineVariables(std::vector<boost::shared_ptr<Variable> >& variables) {
...
void
ModelTestSilentZ_Dyn::defineParameters(std::vector<ParameterModeler>& parameters) {}

void
ModelTestSilentZ_Dyn::defineElements(std::vector<Element>& elements, std::map<std::string, int>& mapElement) {
...
#ifdef _ADEPT_
void
ModelTestSilentZ_Dyn::evalFAdept(const std::vector<adept::adouble>& x, const std::vector<adept::adouble>& xd, std::vector<adept::adouble>& res) {
  /*
    u : x[0]
    der(u) : xd[0]
...
void
ModelTestSilentZ_Dyn::checkDataCoherence() {}

void
ModelTestSilentZ_Dyn::checkParametersCoherence() const {}

void
ModelTestSilentZ_Dyn::setFequations(std::map<int, std::string>& fEquationIndex) {
...
void
ModelTestSilentZ_Dyn::setGequations(std::map<int, std::string>& gEquationIndex) {
  // ---------------- boolean conditions -------------
...
void
ModelTestSilentZ_Dyn::evalCalculatedVars(std::vector<double>& calculatedVars) {
  {
    ...
    if (tmp7) {
      ...
      tmp8 = (((modelica_real)((modelica_integer)data->localData[0]->integerDoubleVars[1] /* z3 DISCRETE */))) *
             (data->localData[0]->realVars[0] /* u STATE(1) */);
    }
...
double
ModelTestSilentZ_Dyn::evalCalculatedVarI(unsigned iCalculatedVar) const {
...
#ifdef _ADEPT_
adept::adouble
ModelTestSilentZ_Dyn::evalCalculatedVarIAdept(unsigned iCalculatedVar, unsigned indexOffset, const std::vector<adept::adouble>& x,
...
void
ModelTestSilentZ_Dyn::getIndexesOfVariablesUsedForCalculatedVarI(unsigned iCalculatedVar, std::vector<int>& indexes) const {
  if (iCalculatedVar == 0) /* x */ {
    indexes.push_back(0);
  }
}
