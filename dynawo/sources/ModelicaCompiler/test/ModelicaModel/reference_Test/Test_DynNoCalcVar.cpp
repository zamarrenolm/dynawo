...
void
ModelTest_Dyn::initData(DYNDATA* d) {
  setData(d);
  setupDataStruc();
  initializeDataStruc();
}
...
void
ModelTest_Dyn::initializeDataStruc() {
...
void
ModelTest_Dyn::deInitializeDataStruc() {
...
void
ModelTest_Dyn::setFomc(double* f, propertyF_t type) {
  if (type != DIFFERENTIAL_EQ) {
...

    {
      ...
      f[1] = data->localData[0]->realVars[2] /*  z variable  */ -
             ((4.0) * ((data->localData[0]->realVars[1] /* y variable */) * (data->localData[0]->realVars[0] /* u STATE(1) */)));
    }
  }
  if (type != ALGEBRAIC_EQ) {
    {
      // ----- Test.Test_eqFunction_7 -----
      $P$DAEres0 = ((-data->simulationInfo->realParameter[1] /* b PARAM */)) * (data->localData[0]->realVars[0] /* u STATE(1) */) -
                   ((data->simulationInfo->realParameter[0] /* a PARAM */) * (data->localData[0]->derivativesVars[0] /* der(u) STATE_DER */));
      f[2] = $P$DAEres0;
    }
  }
}
...
modeChangeType_t
ModelTest_Dyn::evalMode(const double& t) const {
...
void
ModelTest_Dyn::setZomc() {}

void
ModelTest_Dyn::collectSilentZ(bool* silentZTable) {}

void
ModelTest_Dyn::setGomc(state_g* gout) {
...
void
ModelTest_Dyn::setY0omc() {
  data->localData[0]->realVars[0] /* u */ = 1.0;
  { data->localData[0]->realVars[1] /* y variable */ = (2.0) * (data->localData[0]->realVars[0] /* u STATE(1) */); }
  {
    data->localData[0]->realVars[2] /* z variable */ =
        (4.0) * ((data->localData[0]->realVars[1] /* y variable */) * (data->localData[0]->realVars[0] /* u STATE(1) */));
  }
}

void
ModelTest_Dyn::callCustomParametersConstructors() {}

void
ModelTest_Dyn::setYType_omc(propertyContinuousVar_t* yType) {
...
void
ModelTest_Dyn::setFType_omc(propertyF_t* fType) {
...
ModelTest_Dyn::setSharedParametersDefaultValues() {
...
void
ModelTest_Dyn::setParameters(boost::shared_ptr<parameters::ParametersSet> params) {
  a_ = params->getParameter("a")->getDouble();
  b_ = params->getParameter("b")->getDouble();
}

void
ModelTest_Dyn::defineVariables(std::vector<boost::shared_ptr<Variable> >& variables) {
...
void
ModelTest_Dyn::defineParameters(std::vector<ParameterModeler>& parameters) {
...
void
ModelTest_Dyn::defineElements(std::vector<Element>& elements, std::map<std::string, int>& mapElement) {
...
#ifdef _ADEPT_
void
ModelTest_Dyn::evalFAdept(const std::vector<adept::adouble>& x, const std::vector<adept::adouble>& xd, std::vector<adept::adouble>& res) {
  /*
    u : x[0]
    y : x[1]
    z : x[2]
...
void
ModelTest_Dyn::checkDataCoherence() {}

void
ModelTest_Dyn::checkParametersCoherence() const {}

void
ModelTest_Dyn::setFequations(std::map<int, std::string>& fEquationIndex) {
...
void
ModelTest_Dyn::setGequations(std::map<int, std::string>& gEquationIndex) {
  // ---------------- boolean conditions -------------
  // -----------------------------
}

void
ModelTest_Dyn::evalCalculatedVars(std::vector<double>& calculatedVars) {}

double
ModelTest_Dyn::evalCalculatedVarI(unsigned iCalculatedVar) const {
  throw DYNError(Error::MODELER, UndefCalculatedVarI, iCalculatedVar);
}

#ifdef _ADEPT_
adept::adouble
ModelTest_Dyn::evalCalculatedVarIAdept(unsigned iCalculatedVar, unsigned indexOffset, const std::vector<adept::adouble>& x,
...
void
ModelTest_Dyn::getIndexesOfVariablesUsedForCalculatedVarI(unsigned iCalculatedVar, std::vector<int>& indexes) const {}
