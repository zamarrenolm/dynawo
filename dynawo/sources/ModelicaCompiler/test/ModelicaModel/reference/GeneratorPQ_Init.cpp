...
void
ModelGeneratorPQ_Init::initData(DYNDATA* d) {
  setData(d);
  setupDataStruc();
  initializeDataStruc();
}
...
void
ModelGeneratorPQ_Init::setupDataStruc() {
...
void
ModelGeneratorPQ_Init::initializeDataStruc() {
...
void
ModelGeneratorPQ_Init::deInitializeDataStruc() {
...
void
ModelGeneratorPQ_Init::initRpar() {
...
void
ModelGeneratorPQ_Init::setFomc(double* f, propertyF_t type) {
  if (type != DIFFERENTIAL_EQ) {
...

    {
      ...
      f[2] = data->localData[0]->realVars[5] /*  generator.u0Pu.re variable  */ -
             ((data->simulationInfo->realParameter[2] /* generator.U0Pu PARAM */) * ($P$cse2));
    }
...

    {
      ...
      f[3] = data->localData[0]->realVars[4] /*  generator.u0Pu.im variable  */ -
             ((data->simulationInfo->realParameter[2] /* generator.U0Pu PARAM */) * ($P$cse1));
    }

    {
      // ----- GeneratorPQ_INIT_eqFunction_16 -----
      $P$DAEres0 = (data->localData[0]->realVars[4] /* generator.u0Pu.im variable */) * (data->localData[0]->realVars[1] /* generator.i0Pu.re variable */) +
                   ((-data->localData[0]->realVars[5] /* generator.u0Pu.re variable */)) * (data->localData[0]->realVars[0] /* generator.i0Pu.im variable */) -
                   data->localData[0]->realVars[2] /* generator.s0Pu.im variable */;
      f[4] = $P$DAEres0;
    }

    {
      // ----- GeneratorPQ_INIT_eqFunction_17 -----
      $P$DAEres1 = (data->localData[0]->realVars[4] /* generator.u0Pu.im variable */) * (data->localData[0]->realVars[0] /* generator.i0Pu.im variable */) +
                   (data->localData[0]->realVars[5] /* generator.u0Pu.re variable */) * (data->localData[0]->realVars[1] /* generator.i0Pu.re variable */) -
                   data->localData[0]->realVars[3] /* generator.s0Pu.re variable */;
      f[5] = $P$DAEres1;
    }
  }
}
...
modeChangeType_t
ModelGeneratorPQ_Init::evalMode(const double& t) const {
...
void
ModelGeneratorPQ_Init::setGomc(state_g* gout) {
...
void
ModelGeneratorPQ_Init::setZomc() {}

void
ModelGeneratorPQ_Init::collectSilentZ(bool* silentZTable) {}

void
ModelGeneratorPQ_Init::setY0omc() {
  data->localData[0]->realVars[0] /* generator.i0Pu.im */ = 0.0;
  data->localData[0]->realVars[1] /* generator.i0Pu.re */ = 0.0;
  {
    data->localData[0]->realVars[4] /* generator.u0Pu.im variable */ =
        (data->simulationInfo->realParameter[2] /* generator.U0Pu PARAM */) * (sin(data->simulationInfo->realParameter[3] /* generator.UPhase0 PARAM */));
  }
  {
    data->localData[0]->realVars[5] /* generator.u0Pu.re variable */ =
        (data->simulationInfo->realParameter[2] /* generator.U0Pu PARAM */) * (cos(data->simulationInfo->realParameter[3] /* generator.UPhase0 PARAM */));
  }
...
void
ModelGeneratorPQ_Init::callCustomParametersConstructors() {}

boost::shared_ptr<parameters::ParametersSet>
ModelGeneratorPQ_Init::setSharedParametersDefaultValues() {
...
void
ModelGeneratorPQ_Init::setParameters(boost::shared_ptr<parameters::ParametersSet> params) {
...
void
ModelGeneratorPQ_Init::defineElements(std::vector<Element>& elements, std::map<std::string, int>& mapElement) {}

void
ModelGeneratorPQ_Init::defineVariables(std::vector<boost::shared_ptr<Variable> >& variables) {
...
void
ModelGeneratorPQ_Init::defineParameters(std::vector<ParameterModeler>& parameters) {
...
#ifdef _ADEPT_
void
ModelGeneratorPQ_Init::evalFAdept(const std::vector<adept::adouble>& x, const std::vector<adept::adouble>& xd, std::vector<adept::adouble>& res) {
  /*
...
void
ModelGeneratorPQ_Init::checkDataCoherence() {}

void
ModelGeneratorPQ_Init::checkParametersCoherence() const {}

void
ModelGeneratorPQ_Init::setFequations(std::map<int, std::string>& fEquationIndex) {
  ...
  fEquationIndex[4] =
      "$DAEres0 = generator.u0Pu.im * generator.i0Pu.re + (-generator.u0Pu.re) * generator.i0Pu.im - generator.s0Pu.im";               //equation_index_omc:16
...
void
ModelGeneratorPQ_Init::setGequations(std::map<int, std::string>& gEquationIndex) {
  // ---------------- boolean conditions -------------
  // -----------------------------
}

void
ModelGeneratorPQ_Init::setYType_omc(propertyContinuousVar_t* yType) {
...
void
ModelGeneratorPQ_Init::setFType_omc(propertyF_t* fType) {
...
void
ModelGeneratorPQ_Init::evalCalculatedVars(std::vector<double>& calculatedVars) {
...
double
ModelGeneratorPQ_Init::evalCalculatedVarI(unsigned iCalculatedVar) const {
...
#ifdef _ADEPT_
adept::adouble
ModelGeneratorPQ_Init::evalCalculatedVarIAdept(unsigned iCalculatedVar, unsigned indexOffset, const std::vector<adept::adouble>& x,
...
void
ModelGeneratorPQ_Init::getIndexesOfVariablesUsedForCalculatedVarI(unsigned iCalculatedVar, std::vector<int>& indexes) const {}
