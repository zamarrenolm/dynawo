...
model IECFrameRotationAux
  ...
  /*Ouputs*/
  Modelica.Blocks.Interfaces.RealOutput iGsRePu(start = 0) "Real component of the current at the generator system module (converter) terminal in p.u (Ubase,SNom) (generator convention)" annotation(
