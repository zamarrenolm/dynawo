...
model IECMechanical
  ...
  /*Inputs*/
  Modelica.Blocks.Interfaces.RealInput paeroPu(start = -P0Pu * SystemBase.SnRef / SNom) "d-axis reference current at the generator system module (converter) terminal in p.u (Ubase,SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput pagPu(start = -P0Pu * SystemBase.SnRef / SNom) "Maximal d-axis reference current at the generator system module (converter) terminal in p.u (Ubase,SNom) (generator convention)" annotation(
    Placement(visible = true, transformation(origin = {-70, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-110, 0}, extent = {{10, -10}, {-10, 10}}, rotation = 180)));
  /*Ouputs*/
  Modelica.Blocks.Interfaces.RealOutput omegaWTRPu(start = SystemBase.omegaRef0Pu) "Real component of the current at the generator system module (converter) terminal in p.u (Ubase,SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput omegaGenPu(start = SystemBase.omegaRef0Pu) "Imaginary component of the current at the generator system module (converter) terminal in p.u (Ubase,SNom) (generator convention)" annotation(
