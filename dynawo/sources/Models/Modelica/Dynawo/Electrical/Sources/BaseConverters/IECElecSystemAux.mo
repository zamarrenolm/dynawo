...
model IECElecSystemAux
  ...
  */
  ...
  Modelica.Blocks.Interfaces.RealInput iGsRePu(start = 0) "Real component of the current at the converter's terminals (generator system) in p.u (Ubase, SNom) (generator convention)" annotation(
  ...
  Types.PerUnit iGsPu(start = sqrt(IGsIm0Pu^2)) "Module of the current at converter side in p.u (base UNom, SNom)";
