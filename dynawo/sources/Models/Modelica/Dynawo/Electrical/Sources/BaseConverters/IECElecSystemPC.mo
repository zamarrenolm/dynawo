...
model IECElecSystemPC
  ...
  */
  ...
  Modelica.Blocks.Interfaces.RealInput iGsRePu(start = IGsRe0Pu) "Real component of the current at the converter's terminals (generator system) in p.u (Ubase, SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput iGsImPu(start = IGsIm0Pu) "Imaginary component of the current at the converter's terminals (generator system) in p.u (Ubase, SNom) (generator convention)" annotation(
        Placement(visible = true, transformation(origin = {-70, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {110, -50}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  Modelica.Blocks.Interfaces.RealInput iWtRePu(start = -i0Pu.re* SystemBase.SnRef / SNom) "Real component of the current at the wind turbine terminals in p.u (Ubase, SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput iWtImPu(start = -i0Pu.im* SystemBase.SnRef / SNom) "Imaginary component of the current at the wind turbine terminals in p.u (Ubase, SNom) (generator convention)" annotation(
  ...
  Types.PerUnit uGsRePu(start = UGsRe0Pu) "Real component of the current at the wind turbine terminals in p.u (Ubase, SNom) (generator convention)";
  Types.PerUnit uGsImPu(start = UGsIm0Pu) "Imaginary component of the current at the wind turbine terminals in p.u (Ubase, SNom) (generator convention)";
