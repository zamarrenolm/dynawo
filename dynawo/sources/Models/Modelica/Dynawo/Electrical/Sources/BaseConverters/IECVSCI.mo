...
model IECVSCI
  ...
  parameter Types.ComplexPerUnit u0Pu "Start value of the complex voltage at plant terminal (PCC) in p.u (Ubase)" annotation(
    Dialog(group = "group", tab = "Operating point"));
  parameter Types.ComplexPerUnit i0Pu "Start value of the complex current at plant terminal (PCC) in p.u (Ubase, SnRef) (receptor convention)" annotation(
    Dialog(group = "group", tab = "Operating point"));
 ...
 Dialog(group = "group", tab = "Operating point"));
  ...
  parameter Types.PerUnit UpCdm0Pu "Start value of the d-axis reference current at the generator system module (converter) terminal in p.u (Ubase,SNom) in generator convention";
  parameter Types.PerUnit UqCmd0Pu "Start value q-axis reference current at the generator system module (converter) terminal in p.u (Ubase,SNom) in generator convention";
  parameter Types.PerUnit IGsp0Pu "Start value of the d-axis current injected at the PCC in p.u (base UNom, SNom) (generator convention)";
  parameter Types.PerUnit IGsq0Pu "Start value of the q-axis current injected at the PCC in p.u (base UNom, SNom) (generator convention)";
  parameter Types.PerUnit IpConv0Pu "Start value of the d-axis reference current at the generator system module (converter) terminal in p.u (Ubase,SNom) in generator convention";
  parameter Types.PerUnit IqConv0Pu "Start value of the q-axis reference current at the generator system module (converter) terminal in p.u (Ubase,SNom) in generator convention";
  ...
  Modelica.Blocks.Interfaces.RealInput upCmdPu(start = UpCdm0Pu) "d-axis reference current at the generator system module (converter) terminal in p.u (Ubase,SNom) in generator convention" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput uqCmdPu(start = UqCmd0Pu) "q-axis reference current at the generator system module (converter) terminal in p.u (Ubase,SNom) in generator convention" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput uGsRePu(start = UGsRe0Pu) "Real component of the voltage at the generator system module (converter) terminal in p.u (Ubase,SNom) in generator convention" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput uGsImPu(start = UGsIm0Pu) "Imaginary component of the voltage at the generator system module (converter) terminal in p.u (Ubase,SNom) in generator convention" annotation(
  ...
  /*Outputs*/
  Modelica.Blocks.Interfaces.RealOutput iGspPu(start = IGsp0Pu) "d-axis current injected at the PCC in p.u (base UNom, SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput iGsqPu(start = IGsq0Pu) "q-axis current injected at the PCC in p.u (base UNom, SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput uGsqPu(start = UGsq0Pu) "q-axis voltage at the converter terminal (filter) in p.u (base UNom)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput uGspPu(start = UGsp0Pu) "d-axis voltage at the converter terminal (filter) in p.u (base UNom)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput ipConvPu(start = IpConv0Pu)  "d-axis reference current at the generator system module (converter) terminal in p.u (Ubase,SNom) in generator convention" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput iqConvPu(start = IqConv0Pu) "q-axis reference current at the generator system module (converter) terminal in p.u (Ubase,SNom) in generator convention" annotation(
