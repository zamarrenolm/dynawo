...
model WT4AIECelec "Converter Model and grid interface according to IEC 61400-27-1 standard for a wind turbine of type 4A"
  ...
  */
  ...
  Dynawo.Electrical.Sources.BaseConverters.IECElecSystem iECElecSystem(Bes = Bes, Ges = Ges, Xes = Xes, P0Pu = P0Pu, Q0Pu = Q0Pu, Res = Res, SNom = SNom, U0Pu = U0Pu, UPhase0 = UPhase0) annotation(
