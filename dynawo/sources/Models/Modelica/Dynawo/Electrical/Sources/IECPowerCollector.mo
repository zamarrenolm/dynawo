...
model IECPowerCollector
  ...
  parameter Types.PerUnit Rpc "Electrical system serial resistance in p.u (base UNom, SNom)" annotation(
  Dialog(group = "group", tab = "Electrical"));
  parameter Types.PerUnit Xpc "Electrical system serial reactance in p.u (base UNom, SNom)" annotation(
  Dialog(group = "group", tab = "Electrical"));
  ...
  /*Inputs*/
  Modelica.Blocks.Interfaces.RealInput uWtRePu(start = u0Pu.re) "Real component of the voltage at the wind turbine terminals (electrical system) in p.u (base UNom)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput uWtImPu(start = u0Pu.im) "Imaginary component of the voltage at the wind turbine terminals (electrical system) in p.u (base UNom) " annotation(
