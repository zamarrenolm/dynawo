...
model IECWT4AControlVs_INIT "IEC Wind Turbine type 4A Control"
  ...
  Types.ComplexPerUnit i0Pu "Start value of the complex current at plant terminal (PCC) in p.u (base UNom, SnRef)";

  Types.PerUnit UGsRe0Pu "Starting value of the real component of the voltage at the converter's terminals (generator system) in p.u (base UNom)";
  Types.PerUnit UGsIm0Pu "Real component of the voltage at the converter's terminals (generator system) in p.u (base UNom)";

  Types.PerUnit IGsRe0Pu "Initial value of the real component of the current at the generator system module (converter) terminal in p.u (Ubase, SNom) in generator convention";
  Types.PerUnit IGsIm0Pu "Initial value of the imaginary component of the current at the generator system module (converter) terminal in p.u (Ubase, SNom) in generator convention";

  Types.PerUnit UGsp0Pu "Start value of the d-axis voltage at the converter terminal (filter) in p.u (base UNom)";
  Types.PerUnit UGsq0Pu "Start value of the q-axis voltage at the converter terminal (filter) in p.u (base UNom)";
...
equation
  ...
  u0Pu = ComplexMath.fromPolar(U0Pu, UPhase0) "Start value of the complex voltage at plant terminal (PCC) in p.u (base UNom)";
  i0Pu = ComplexMath.conj(Complex(P0Pu, Q0Pu) / u0Pu) "Start value of the complex current at plant terminal (PCC) in p.u (base UNom, SnRef)";

  UGsRe0Pu = u0Pu.re - Res * (i0Pu.re* SystemBase.SnRef / SNom) + Xes * (i0Pu.im* SystemBase.SnRef / SNom) "Starting value of the real component of the voltage at the converter's terminals (generator system) in p.u (base UNom)";
  ...
  IpConv0Pu = IGsp0Pu - SystemBase.omegaRef0Pu * Cfilter * UGsp0Pu "Start value of the d-axis current injected at the PCC in p.u (base UNom, SNom) (generator convention)";
  IqConv0Pu = IGsq0Pu + SystemBase.omegaRef0Pu * Cfilter * UGsq0Pu "Start value of the q-axis current injected at the PCC in p.u (base UNom, SNom) (generator convention)";
