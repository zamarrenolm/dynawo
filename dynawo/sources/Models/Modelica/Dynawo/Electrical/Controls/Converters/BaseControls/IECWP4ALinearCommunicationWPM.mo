...
model IECWP4ALinearCommunicationWPM
  ...
  Dynawo.NonElectrical.Blocks.Continuous.LeadLag leadLag2(T1 = Tlead, T2 = Tlag, y_start = U0Pu) annotation(
    Placement(visible = true, transformation(origin = {0, -30}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  Dynawo.NonElectrical.Blocks.Continuous.LeadLag leadLag3(T1 = Tlead, T2 = Tlag, y_start = SystemBase.omegaRef0Pu) annotation(
