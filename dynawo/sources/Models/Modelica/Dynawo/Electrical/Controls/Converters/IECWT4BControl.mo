...
model IECWT4BControl "IEC Wind Turbine type 4A Control"
  ...
  Modelica.Blocks.Interfaces.RealInput omegaGenPu(start = SystemBase.omegaRef0Pu) "Imaginary component of the current at the generator system module (converter) terminal in p.u (Ubase,SNom) (generator convention)" annotation(
