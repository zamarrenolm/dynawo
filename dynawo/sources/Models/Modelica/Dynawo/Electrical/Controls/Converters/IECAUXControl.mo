...
model IECAUXControl "IEC Wind Turbine type 4A Control"
  ...
  /*Inputs*/
  Modelica.Blocks.Interfaces.RealInput iWtRePu(start = 0) "Real component of the current at the wind turbine terminals in p.u (Ubase,SNom) in generator convention" annotation(
  ...
  /*Outputs*/
  Modelica.Blocks.Interfaces.RealOutput ipCmdPu(start = 0) "d-axis reference current at the generator system module (converter) terminal in p.u (Ubase,SNom) in generator convention" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput ipMaxPu(start = 0) "Maximal d-axis reference current at the generator system module (converter) terminal in p.u (Ubase,SNom) in generator convention" annotation(
