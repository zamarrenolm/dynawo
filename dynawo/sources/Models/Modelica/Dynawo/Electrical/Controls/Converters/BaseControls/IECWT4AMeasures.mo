...
model IECWT4AMeasures
  ...
  Modelica.Blocks.Math.Add add annotation(
    Placement(visible = true, transformation(origin = {62, -100.5}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Modelica.Blocks.Continuous.Derivative derivative(T = Tffilt, k = 1 / SystemBase.omegaNom, x_start = UPhase0, y_start = 0) annotation(
    Placement(visible = true, transformation(origin = {10, -81.5}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
...
/* Injected power at PCC in nominal and system bases */
  ...
  connect(add.y, omegaRefFiltPu) annotation(
    Line(points = {{73, -100.5}, {120, -100.5}}, color = {0, 0, 127}));
  ...
  connect(derivative.y, add.u1) annotation(
    Line(points = {{21, -81.5}, {30, -81.5}, {30, -94.5}, {50, -94.5}}, color = {0, 0, 127}));
  ...
  connect(rectangularToPolar1.y_arg, theta) annotation(
    Line(points = {{-28, -50}, {46, -50}, {46, -60}, {120, -60}}, color = {0, 0, 127}));
  connect(omegaRefPu, add.u2) annotation(
    Line(points = {{-120, -100}, {-80, -100}, {-80, -106.5}, {50, -106.5}}, color = {0, 0, 127}));
