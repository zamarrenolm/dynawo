...
model IECWT4A "GWind Turbine Type 4A model from IEC 61400-27-1 standard with infinite bus - fault and reference tracking tests (Active and reactive power steps)"
  ...
  */
  ...
  Dynawo.Electrical.Buses.InfiniteBus infiniteBus(UPhase = 0, UPu = 1.05) annotation(
    Placement(visible = true, transformation(origin = {130, 0}, extent = {{-20, -20}, {20, 20}}, rotation = -90)));
  ...
  Dynawo.Electrical.Transformers.TransformerFixedRatio transformer2(BPu = 0, GPu = 0, RPu = 0, XPu = 0.05, rTfoPu = 1) annotation(
    Placement(visible = true, transformation(origin = {-75, 0}, extent = {{-15, -15}, {15, 15}}, rotation = 0)));
  ...
  Dynawo.Electrical.Events.NodeFault nodeFault(RPu = 0, XPu = 0.001, tBegin = 3, tEnd = 3.15) annotation(
    Placement(visible = true, transformation(origin = {-90, -30}, extent = {{-15, 15}, {15, -15}}, rotation = 0)));
  Dynawo.Examples.IECWT4ANeplan.BaseModel.IECWT4A iecwt4a(Bes = 0, DipMax = 1, DiqMax = 100, DiqMin = -100, DpMaxp4A = 1, DpRefMax4A = 100, DpRefMin4A = -100, Ges = 0, IMax = 1.3, IMaxDip = 1.3, IMaxHookPu = 0, IdfHook = 0, IpMax0Pu = 1.2, IpfHook = 0, IqH1 = 1.05, IqMax = 1.05, IqMax0Pu = 0.4, IqMaxHook = 0, IqMin = -1.05, IqMin0Pu = -0.4, IqPost = 0, Kiq = 0, Kiu = 0, Kpq = 1.1, Kpqu = 20, Kpu = 2, Kpufrt = 2, Kqv = 2, Mdfslim = false, MpUScale = false, MqG = 1, Mqfrt = 0, Mqpri = true, P0Pu = -1, PstepHPu = -0.5, Q0Pu = 0.21, QMax = 0.33, QMax0Pu = 0.33, QMin = -0.33, QMin0Pu = -0.33, QlConst = true, QstepHPu = 0.41, RDrop = 0, Res = 0, SNom = 100, TanPhi = 0.3, Td = 0, Tffilt = 0.01, Tg = 0.01, TpOrdp4A = 0.1, TpWTRef4A = 0.01, Tpfilt = 0.01, Tpll = 0.01, TqOrd = 0.001, Tqfilt = 0.01, Ts = 0, Tufilt = 0.01, Tuss = 1, U0Pu = 1, UMax = 1.1, UMin = 0.9, UPhase0 = 0.22, UdbOne = -0.1, UdbTwo = 0.1, UpDip = 0, Upll1 = 999, Upll2 = 0.13, UpquMax = 1.1, UqDip = 0.9, UqRise = 1.1, XDrop = 0, Xes = 0, t_Pstep = 1, t_Qstep = 2)  annotation(
...
equation
  ...
  connect(line.terminal2, transformer.terminal2) annotation(
    Line(points = {{-10, 0}, {10, 0}, {10, 0}, {10, 0}}, color = {0, 0, 255}));
  connect(transformer.terminal1, line2.terminal1) annotation(
    Line(points = {{40, 0}, {46, 0}, {46, -20}, {50, -20}, {50, -20}}, color = {0, 0, 255}));
  ...
  connect(line3.terminal2, infiniteBus.terminal) annotation(
    Line(points = {{120, -20}, {124, -20}, {124, 0}, {130, 0}, {130, 0}}, color = {0, 0, 255}));
  connect(transformer.terminal1, line1.terminal1) annotation(
    Line(points = {{40, 0}, {46, 0}, {46, 20}, {70, 20}, {70, 20}}, color = {0, 0, 255}));
  connect(line1.terminal2, infiniteBus.terminal) annotation(
    Line(points = {{100, 20}, {124, 20}, {124, 0}, {130, 0}, {130, 0}}, color = {0, 0, 255}));
  connect(transformer2.terminal1, nodeFault.terminal) annotation(
    Line(points = {{-90, 0}, {-90, 0}, {-90, -30}, {-90, -30}}, color = {0, 0, 255}));
 connect(iecwt4a.aCPower, transformer2.terminal1) annotation(
    Line(points = {{-104, 0}, {-90, 0}, {-90, 0}, {-90, 0}}, color = {0, 0, 255}));
 annotation(
