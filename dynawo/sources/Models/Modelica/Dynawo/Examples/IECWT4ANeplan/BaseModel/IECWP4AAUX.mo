...
equation
 ...
 connect(iECPowerCollector.aCPower1, aCPower) annotation(
    Line(points = {{-192, 10}, {-213, 10}}, color = {0, 0, 255}));
 connect(wT4AIECelec.terminal, iECPowerCollector.aCPower) annotation(
 ...
 connect(iECPowerCollector.aCPower2, wT4AIECelecAux.terminal) annotation(
